...
class SomeIpAgentState(TypedDict):
    ...
    guard: NotRequired[dict[str, Any]]
    reflection: NotRequired[dict[str, Any] | None]
    reflection_count: NotRequired[int]
    reflection_feedback_hashes: NotRequired[list[str]]
    revision_count: NotRequired[int]
    supplemental_tool_rounds: NotRequired[int]
    supplemental_query: NotRequired[str | None]
